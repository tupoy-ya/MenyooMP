...
namespace sub
{
	namespace MapMods_catind
	{
		...
		std::vector<GTAmapmod> vAllMapMods{GTAmapmod("10C Garage Troll", {229.3570f, -992.9106f, -98.9999f}, mmf_10cGarageTroll), GTAmapmod("2C Garage Troll", {173.0831f, -1004.005f, -98.2410f}, mmf_2cGarageTroll), GTAmapmod("UFO Tower With FIB Building", {70.9744f, -674.3677f, 679.3784f}, mmf_ufoTower1), GTAmapmod("Airport Drag Strip", {-940.6546f, -3178.347f, 13.9444f}, mmf_AirportDragStrip), GTAmapmod("Airport Drift Track", {-946.1713f, -3084.833f, 19.5450f}, mmf_AirportDriftTrack), GTAmapmod("Airport Gate Ramp", {-1045.602f, -2536.369f, 20.2124f}, mmf_airportGateRamp1), GTAmapmod("Airport Mini-Ramp", {-1066.148f, -3029.479f, 13.9451f}, mmf_airportMiniRamp1), GTAmapmod("Beach Ferris Loop", {-1505.678f, -1194.213f, 4.3786f}, mmf_beechFerrisRamp1), GTAmapmod("Maze Bank Roof-Ramp", {-74.9424f, -818.63446f, 326.1743f}, mmf_mazeRoofMiniRamp1), GTAmapmod("Maze Bank Demo Derby", {-78.9328f, -822.7497f, 326.1751f}, mmf_mazeDerbyFerrisTree), GTAmapmod("Maze Bank City-Ramp", {-78.9328f, -822.7497f, 326.1751f}, mmf_city691), GTAmapmod("Maze Bank Halfpipes", {-74.9424f, -818.63446f, 326.1743f}, mmf_MazeHalfPipes1), GTAmapmod("Maze Bank Piece Track", {-74.9424f, -818.6345f, 326.1743f}, mmf_MazeBankPieceTrack), GTAmapmod("Downtown Bobsled", {-144.823f, -592.133f, 210.764f}, mmf_DowntownBobsled), GTAmapmod("Airport WallRide", {-994.7432f, -2562.467f, 36.1194f}, mmf_AirportWallRide), GTAmapmod("LSC Troll", {-347.8090f, -155.7320f, 60.4215f}, mmf_lscTroll), GTAmapmod("LSC Skatepark", {-371.7577f, -84.0345f, 45.6634f}, mmf_lscSkatePark)};
		...
		{
			bool pressed = false;
			AddOption(mm.Name(), pressed, nullFunc, SUB::MAPMODS2, false);
			if (pressed)
			{
				currentMAPMODC = &mm;
			}
