...
namespace sub::TeleportLocations_catind
{
	namespace IplNames
	{
		const std::vector<std::string_view> vYacht_Smboat1{{"smboat"_sv}, {"smboat_lod"_sv}};
		const std::vector<std::string_view> vYacht_Heist1{//{ "smboat_lod"_sv },
		    {"hei_yacht_heist"_sv},
		...
		const std::vector<std::string_view> vYacht_Heist2{{"gr_heist_yacht2"_sv}, {"gr_heist_yacht2_bar"_sv}, {"gr_heist_yacht2_bedrm"_sv}, {"gr_heist_yacht2_bridge"_sv}, {"gr_heist_yacht2_enginrm"_sv}, {"gr_heist_yacht2_lounge"_sv}, {"gr_heist_yacht2_lod"_sv}, {"gr_heist_yacht2_slod"_sv}};
		const std::vector<std::string_view> vAircraftCarrier1{{"hei_carrier"_sv}, {"hei_carrier_DistantLights"_sv}, {"hei_Carrier_int1"_sv}, {"hei_Carrier_int2"_sv}, {"hei_Carrier_int3"_sv}, {"hei_Carrier_int4"_sv}, {"hei_Carrier_int5"_sv}, {"hei_Carrier_int6"_sv}, {"hei_carrier_LODLights"_sv}};
		const std::vector<std::string_view> vNorthYankton{//{ "prologue_m2_door"_sv },
		    ...
		    {"prologuerdb"_sv},
		    {"prologuerd_lod"_sv}};
		const std::vector<std::string_view> vAllCustomisableApartments1{{"apa_v_mp_h_01_a"_sv}, {"apa_v_mp_h_01_c"_sv}, {"apa_v_mp_h_01_b"_sv}, {"apa_v_mp_h_02_a"_sv}, {"apa_v_mp_h_02_c"_sv}, {"apa_v_mp_h_02_b"_sv}, {"apa_v_mp_h_03_a"_sv}, {"apa_v_mp_h_03_c"_sv}, {"apa_v_mp_h_03_b"_sv}, {"apa_v_mp_h_04_a"_sv}, {"apa_v_mp_h_04_c"_sv}, {"apa_v_mp_h_04_b"_sv}, {"apa_v_mp_h_05_a"_sv}, {"apa_v_mp_h_05_c"_sv}, {"apa_v_mp_h_05_b"_sv}, {"apa_v_mp_h_06_a"_sv}, {"apa_v_mp_h_06_c"_sv}, {"apa_v_mp_h_06_b"_sv}, {"apa_v_mp_h_07_a"_sv}, {"apa_v_mp_h_07_c"_sv}, {"apa_v_mp_h_07_b"_sv}, {"apa_v_mp_h_08_a"_sv}, {"apa_v_mp_h_08_c"_sv}, {"apa_v_mp_h_08_b"_sv}};
		const std::vector<std::string_view> vAllOffices1{{"ex_dt1_02_office_01a"_sv}, {"ex_dt1_02_office_01b"_sv}, {"ex_dt1_02_office_01c"_sv}, {"ex_dt1_02_office_02a"_sv}, {"ex_dt1_02_office_02b"_sv}, {"ex_dt1_02_office_02c"_sv}, {"ex_dt1_02_office_03a"_sv}, {"ex_dt1_02_office_03b"_sv}, {"ex_dt1_02_office_03c"_sv}, {"ex_dt1_11_office_01a"_sv}, {"ex_dt1_11_office_01b"_sv}, {"ex_dt1_11_office_01c"_sv}, {"ex_dt1_11_office_02a"_sv}, {"ex_dt1_11_office_02b"_sv}, {"ex_dt1_11_office_02c"_sv}, {"ex_dt1_11_office_03a"_sv}, {"ex_dt1_11_office_03b"_sv}, {"ex_dt1_11_office_03c"_sv}, {"ex_sm_13_office_01a"_sv}, {"ex_sm_13_office_01b"_sv}, {"ex_sm_13_office_01c"_sv}, {"ex_sm_13_office_02a"_sv}, {"ex_sm_13_office_02b"_sv}, {"ex_sm_13_office_02c"_sv}, {"ex_sm_13_office_03a"_sv}, {"ex_sm_13_office_03b"_sv}, {"ex_sm_13_office_03c"_sv}, {"ex_sm_15_office_01a"_sv}, {"ex_sm_15_office_01b"_sv}, {"ex_sm_15_office_01c"_sv}, {"ex_sm_15_office_02a"_sv}, {"ex_sm_15_office_02b"_sv}, {"ex_sm_15_office_02c"_sv}, {"ex_sm_15_office_03a"_sv}, {"ex_sm_15_office_03b"_sv}, {"ex_sm_15_office_03c"_sv}};

		const std::vector<std::string_view> vAllOfficeGarages1{{"imp_dt1_02_modgarage"_sv}, {"imp_dt1_02_cargarage_a"_sv}, {"imp_dt1_02_cargarage_b"_sv}, {"imp_dt1_02_cargarage_c"_sv}, {"imp_dt1_11_modgarage"_sv}, {"imp_dt1_11_cargarage_a"_sv}, {"imp_dt1_11_cargarage_b"_sv}, {"imp_dt1_11_cargarage_c"_sv}, {"imp_sm_13_modgarage"_sv}, {"imp_sm_13_cargarage_a"_sv}, {"imp_sm_13_cargarage_b"_sv}, {"imp_sm_13_cargarage_c"_sv}, {"imp_sm_15_modgarage"_sv}, {"imp_sm_15_cargarage_a"_sv}, {"imp_sm_15_cargarage_b"_sv}, {"imp_sm_15_cargarage_c"_sv}};
...
#pragma region landmarks
		const std::vector<TeleLocation> vLandMarks{
		    ...
		    TeleLocation("Far N0rth San Andreas", 24.775f, 7644.102f, 19.055f),
...
#pragma region interiors
		const std::vector<TeleLocation> vInteriors{
		    ...
		    TeleLocation("Bank (N0rth Yankton)", 5309.519f, -5212.375f, 83.522f, IplNames::vNorthYankton, {}),
...
#pragma region apartment interiors
		const std::vector<TeleLocation> vApartmentInteriors{
		    ...
		    TeleLocation(true, 340.941f, 437.18f, 149.39f, "2044 N0rth Conker Avenue"),
		    TeleLocation(true, 373.023f, 416.105f, 145.701f, "2045 N0rth Conker Avenue"),
...
#pragma region offices
		const std::vector<TeleLocation> vOffices_ArcadiusBusinessCentre{TeleLocation("Executive Rich", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_02b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Executive Cool", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_02c"_sv}, IplNames::vAllOffices1, true), TeleLocation("Executive Contrast", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_02a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Warm", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_01a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Classical", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_01b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Vintage", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_01c"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Ice", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_03a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Conservative", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_03b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Polished", -139.1000f, -631.8000f, 168.8000f, {"ex_dt1_02_office_03c"_sv}, IplNames::vAllOffices1, true)};
		const std::vector<TeleLocation> vOffices_MazeBankBuilding{TeleLocation("Executive Rich", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_02b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Executive Cool", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_02c"_sv}, IplNames::vAllOffices1, true), TeleLocation("Executive Contrast", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_02a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Warm", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_01a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Classical", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_01b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Vintage", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_01c"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Ice", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_03a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Conservative", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_03b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Polished", -73.1000f, -816.8000f, 243.4000f, {"ex_dt1_11_office_03c"_sv}, IplNames::vAllOffices1, true)};
		const std::vector<TeleLocation> vOffices_LombankWest{TeleLocation("Executive Rich", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_02b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Executive Cool", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_02c"_sv}, IplNames::vAllOffices1, true), TeleLocation("Executive Contrast", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_02a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Warm", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_01a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Classical", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_01b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Vintage", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_01c"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Ice", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_03a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Conservative", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_03b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Polished", -1573.1000f, -571.9000f, 108.5000f, {"ex_sm_13_office_03c"_sv}, IplNames::vAllOffices1, true)};
		const std::vector<TeleLocation> vOffices_MazeBankWest{TeleLocation("Executive Rich", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_02b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Executive Cool", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_02c"_sv}, IplNames::vAllOffices1, true), TeleLocation("Executive Contrast", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_02a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Warm", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_01a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Classical", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_01b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Old Spice Vintage", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_01c"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Ice", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_03a"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Conservative", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_03b"_sv}, IplNames::vAllOffices1, true), TeleLocation("Power Broker Polished", -1382.3000f, -477.9000f, 72.0000f, {"ex_sm_15_office_03c"_sv}, IplNames::vAllOffices1, true)};
...
#pragma region others
		const std::vector<TeleLocation> vOthers{
		    ...
		    TeleLocation("N0rth Yankton", 3217.697021f, -4834.826f, 111.8148f, IplNames::vNorthYankton, {}), // Angled roads and vehicle generators or nah?
...
#pragma endregion
		...
		const std::vector<NamedTeleLocationList> vAllCategories{//{ "Name", &LocationList, &NextLocationListVector|NextSubmenu
