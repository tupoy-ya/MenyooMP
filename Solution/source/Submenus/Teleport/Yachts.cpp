...
namespace sub::TeleportLocations_catind
{
	namespace Yachts
	{
		const std::vector<TeleLocation> vOtherYachtRelatedTeleports{TeleLocation("Dignity Party (Vespucci Beach)", -2023.455f, -1038.181f, 8.0629f, IplNames::vYacht_Smboat1, IplNames::vYacht_Heist1, false), TeleLocation("Dignity Heist (Vespucci Beach)", -2023.455f, -1038.181f, 8.0629f, IplNames::vYacht_Heist1, IplNames::vYacht_Smboat1, true), TeleLocation("Gunrunning Heist (Paleto Bay)", -1368.7260f, 6736.3266f, 7.0000f, IplNames::vYacht_Heist2, {}, true)};
		struct CoordinatesWithHeading
		{
			Vector3 pos;
			float h;
		};
		struct YachtLocation
		{
			const std::string name;
			CoordinatesWithHeading poses[3];
		};
		const std::map<uint8_t, YachtLocation> vGroupLocations{{1, {"Lago Zancudo", {{{-3542.8215f, 1488.2498f, 5.4300f}, -123.0449f}, {{-3148.37912f, 2807.5549f, 5.4300f}, 91.95499f}, {{-3280.5012f, 2140.5071f, 5.4300f}, 86.9550f}}}}, {2, {"N0rth Chumash", {{{-2814.4895f, 4072.7398f, 5.4300f}, -108.04495f}, {{-3254.5520f, 3685.6765f, 5.4300f}, 81.9550f}, {{-2368.4412f, 4697.8740f, 5.4300f}, -133.0450f}}}}, {3, {"Pacific Bluffs", {{{-3205.3440f, -219.0104f, 5.4300f}, 176.9550f}, {{-3448.2542f, 311.5018f, 5.4300f}, -83.04494f}, {{-2697.8616f, -540.6123f, 5.4300f}, 146.9550f}}}}, {4, {"Vespucci Beach", {{{-1995.7343f, -1523.6902f, 5.4300f}, -38.0450f}, {{-2117.5806f, -2543.3460f, 5.4300f}, 36.9550f}, {{-1605.0737f, -1872.4680f, 5.4300f}, -68.0450f}}}}, {5, {"Los Santos International Airport", {{{-753.0817f, -3919.0676f, 5.4300f}, 11.9550f}, {{-351.0608f, -3553.3235f, 5.4300f}, -123.0450f}, {{-1460.5361f, -3761.4670f, 5.4300f}, 161.9550f}}}}, {6, {"Terminal", {{{1546.8916f, -3045.6270f, 5.4300f}, -118.0445f}, {{2490.8855f, -2428.8481f, 5.4300f}, -168.0450f}, {{2049.7898f, -2821.6240f, 5.4300f}, 31.9550f}}}}, {7, {"Palomino Highlands", {{{3029.0183f, -1495.7024f, 5.4300f}, -108.0450f}, {{3021.2537f, -723.3903f, 5.4300f}, 81.9550f}, {{2976.6218f, -1994.7598f, 5.4300f}, -133.0450f}}}}, {8, {"Tataviam Mountains", {{{3404.5095f, 1977.0444f, 5.4300f}, -103.0450f}, {{3411.1003f, 1193.4446f, 5.4300f}, 31.95502f}, {{3784.8025f, 2548.5413f, 5.4300f}, 86.9551f}}}}, {9, {"San Chianski Mountain Range", {{{4225.0283f, 3988.0015f, 5.4300f}, 61.9551f}, {{4250.5811f, 4576.5654f, 5.4300f}, 111.9550f}, {{4204.3555f, 3373.7002f, 5.4300f}, 81.9550f}}}}, {10, {"Mount Gordo", {{{3751.6814f, 5753.5010f, 5.4300f}, 136.9550f}, {{3490.1052f, 6305.7852f, 5.4300f}, 156.9550f}, {{3684.8533f, 5212.2383f, 5.4300f}, -58.0450f}}}}, {11, {"Procopio Beach", {{{581.5955f, 7124.5576f, 5.4300f}, 121.9550f}, {{2004.4617f, 6907.1572f, 5.4300f}, 6.9550f}, {{1396.6379f, 6860.2031f, 5.4300f}, 176.9550f}}}}, {12, {"Paleto Bay", {{{-1170.6904f, 5980.6816f, 5.4300f}, 91.9550f}, {{-777.4865f, 6566.9072f, 5.4300f}, 26.9549f}, {{-381.7739f, 6946.9600f, 5.4300f}, 71.9550f}}}}};
		...
		const std::map<uint8_t, YachtBmp> vOptionNames{{1, {"The Orion", "yacht_model_0_0"}}, {2, {"The Pisces", "yacht_model_1_0"}}, {3, {"The Aquarius", "yacht_model_2_0"}}};
		...
		void CreateYacht(YachtBuildInfoStructure& yachtInfo)
		{
			...
			if (yachtInfo.location != nullptr && yachtInfo.option != nullptr)
			{
				...
				if (!propYacht.Exists() && !propYachtArr.empty())
				{
					if (DOES_ENTITY_EXIST(propYachtArr.front()))
				...
				switch (optionNumber)
				{
				case 1: optionColModels = {"apa_mp_apa_yacht_option1", "apa_mp_apa_yacht_option1_cola"}; break;
				case 2:
				...
				for (auto& doorOffset : std::vector<std::pair<Vector3, Vector3>>{{{0.01894f, -3.3871f, 6.6600f}, {0.0000f, 0.0000f, 90.2950f}}, {{0.0046f, -0.6018f, 6.6600f}, {0.0000f, 0.0000f, -89.7050f}}, {{-36.8202f, -1.2778f, 0.6500f}, {0.0000f, 0.0000f, -89.9550f}}})
				{
				...
				std::map<uint8_t, std::vector<std::pair<Vector3, float>>> radomeOffsets{{1, {{{0.95549f, -2.1682f, 9.6040f}, 90.0000f}, {{1.2820f, -1.9895f, 13.4305f}, -180.0000f}, {{5.4844f, -1.9817f, 18.1568f}, -90.0000f}}}, {2, {{{-2.2487f, -1.9926f, 17.3200f}, -90.0000f}, {{1.6188f, -1.9927f, 14.0505f}, -180.0000f}, {{7.6349f, -1.9927f, 10.3491f}, 90.0000f}}}, {3, {{{10.8361f, -1.9899f, 9.8530f}, 90.0000f}, {{-0.2231f, -1.9601f, 12.8964f}, 180.0000f}, {{-15.0487f, -1.9918f, 9.0674f}, 90.0000f}}}};
				...
				// Buoys
				for (auto& b : std::vector<Vector3>{{-53.4131f, -10.0086f, -6.0113f}, {-1631.3173f, -1819.5632f, -0.6474f}, {-58.8841f, 0.2735f, -6.1121f}, {-1619.7332f, -1820.7730f, -0.8027f}})
				{
				...
				// Vehicles
				std::map<uint8_t, std::vector<std::tuple<Model, Vector3, Vector3>>> vVehicleOffsetsArr{{1, {std::make_tuple<Model, Vector3, Vector3>(VEHICLE_TROPIC2, {-54.3528f, -13.3907f, -5.1819f}, {1.6733f, 1.9946f, -109.0565f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SEASHARK3, {-61.5043f, -8.9306f, -5.5869f}, {4.1636f, -0.8436f, 116.3082f})}}, {2, {std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SEASHARK3, {-61.5275f, 4.6035f, -5.3742f}, {4.6320f, -1.7134f, 63.7883f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SEASHARK3, {-61.5155f, -8.896f, -5.3594f}, {4.5635f, -1.1910f, -243.6808f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_DINGHY4, {-54.3522f, -13.3903f, -4.8438f}, {4.8526f, -1.0505f, -109.0528f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SPEEDER2, {-53.7848f, 9.1620f, -4.6511f}, {3.3195f, 0.8531f, -69.9578f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SWIFT2, {-30.8168f, -1.8687f, 6.5134f}, {-0.2890f, 0.0000f, -90.0000f})}}, {3, {std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SEASHARK3, {-61.5189f, 2.3503f, -5.8703f}, {5.6612f, 0.2225f, 64.4417f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SEASHARK3, {-61.5050f, -8.9017f, -5.6858f}, {7.4903f, -0.0753f, 116.2442f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SEASHARK3, {-61.52280f, 4.5982f, -5.8566f}, {5.9844f, -0.3815f, 64.5492f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SEASHARK3, {-61.5087f, -6.6536f, -5.7382f}, {7.2774f, 0.9445f, 114.6004f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_DINGHY4, {-54.3447f, -13.3947f, -5.4129f}, {3.6041f, -2.1484f, -108.2869f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_TORO, {-54.3726f, 9.1093f, -5.5979f}, {-1.8536f, 0.7891f, -69.8533f}), std::make_tuple<Model, Vector3, Vector3>(VEHICLE_SUPERVOLITO2, {-30.8329f, -1.8728f, 7.2883f}, {0.0409f, 0.0000f, -90.0000f})}}};
				...
				for (auto& v : vVehicleOffsets)
				{
					...
					if (std::get<0>(v).IsBoat())
						SET_BOAT_ANCHOR(veh.Handle(), true);
				     ...
				     })
				{
					...
					{
						if (!animArgs.effect.empty())
						{
							ped.Task().StartScenario(animArgs.effect);
						}
					}
				...
				{
					currentYachtInfo.vMarkerPositions.push_back(
					    {propYachtWin.GetOffsetInWorldCoords(v.first), propYachtWin.GetOffsetInWorldCoords(v.second)});
				}
			}
		}
		...
		void TeleportPedToYacht(const GTAentity ped, YachtBuildInfoStructure& yachtInfo)
		{
			if (yachtInfo.location != nullptr)
			{
				...
				if (yachtInfo.yachtProp.Exists())
					...
					teleport_net_ped(ped,
					    yachtPos
					        + Vector3::RotationToDirection(Vector3::DirectionToRotation(teleOffset) + Vector3(0, 0, posh.h))
					            * teleOffset.Length());
			}
		}
		...
		void Sub_Yachts()
		{
			...
			for (auto& grp : vGroupLocations)
			{
				...
				AddOption(grp.second.name, bGrpLocPressed, nullFunc, SUB::TELEPORTOPS_YACHTS_INGRP);
				if (bGrpLocPressed)
				{
					if (oldYachtInfo == nullptr)
					{
		...
		void Sub_Yachts_InGrp()
		{
			...
			if (bInternalLoc_plus)
			{
				if (currentYachtInfo.internalLocationIndex < 3)
				{
					currentYachtInfo.internalLocationIndex++;
				}
			}
			if (bInternalLoc_minus)
			{
				if (currentYachtInfo.internalLocationIndex > 1)
				{
					currentYachtInfo.internalLocationIndex--;
				}
			}
			...
			if (*Menu::currentopATM == Menu::printingop)
				DrawYachtBmpPreview(currentYachtInfo.option->first);
			if (bYachtType_plus)
			{
				if (vOptionNames.rbegin()->first != currentYachtInfo.option->first)
				{
					currentYachtInfo.option = &*(++vOptionNames.find(currentYachtInfo.option->first));
				}
			}
			if (bYachtType_minus)
			{
				if (vOptionNames.begin()->first != currentYachtInfo.option->first)
				{
					currentYachtInfo.option = &*(--vOptionNames.find(currentYachtInfo.option->first));
				}
			}
			...
			if (bYachtPaint_plus)
			{
				if (currentYachtInfo.yachtPropTextureVariation < YachtPropPaintVariation::vNames.size() - 1)
				{
					currentYachtInfo.yachtPropTextureVariation++;
				}
			}
			if (bYachtPaint_minus)
			{
				if (currentYachtInfo.yachtPropTextureVariation > 0)
				{
					currentYachtInfo.yachtPropTextureVariation--;
				}
			}
			...
			if (bRailings_plus)
			{
				if (currentYachtInfo.railingColour < 'b')
				{
					currentYachtInfo.railingColour++;
				}
			}
			if (bRailings_minus)
			{
				if (currentYachtInfo.railingColour > 'a')
				{
					currentYachtInfo.railingColour--;
				}
			}
			...
			if (bLightingType_plus)
			{
				if (currentYachtInfo.lightingType < 2)
				{
					currentYachtInfo.lightingType++;
				}
			}
			if (bLightingType_minus)
			{
				if (currentYachtInfo.lightingType > 1)
				{
					currentYachtInfo.lightingType--;
				}
			}
			...
			if (bLightingColour_plus)
			{
				if (currentYachtInfo.lightingColour < 'd')
				{
					currentYachtInfo.lightingColour++;
				}
			}
			if (bLightingColour_minus)
			{
				if (currentYachtInfo.lightingColour > 'a')
				{
					currentYachtInfo.lightingColour--;
				}
			}
			...
			if (bDoorColour_plus)
			{
				if (currentYachtInfo.doorColour == '\0')
				{
					currentYachtInfo.doorColour = '2';
				}
			}
			if (bDoorColour_minus)
			{
				if (currentYachtInfo.doorColour == '2')
				{
					currentYachtInfo.doorColour = '\0';
				}
			}
			...
			if (bFlagIndex_plus)
			{
				if (currentYachtInfo.flagIndex < vFlagSuffixes.size() - 1)
				{
					currentYachtInfo.flagIndex++;
				}
			}
			if (bFlagIndex_minus)
			{
				if (currentYachtInfo.flagIndex > 0)
				{
					currentYachtInfo.flagIndex--;
				}
			}
			...
			if (bCreateYachtPressed)
			{
				...
				for (auto& sclf : currentYachtInfo.vScaleforms)
					sclf.first.Unload();
						...
						if (!YachtOffsets::bPlayerJustTeleportedBetweenMarkers)
						{
							if (!bMyPedIsInVehicle)
							{
								if (myPos.DistanceTo(p.first) < scale)
								{
									...
									TASK_GO_STRAIGHT_TO_COORD(0,
									    outsideMarkerPos.x,
									    outsideMarkerPos.y,
									    outsideMarkerPos.z,
									    1.5f,
									    2000,
									    Vector3::DirectionToRotation(Vector3::Normalize(outsideMarkerPos - p.second)).z,
									    0.0f);
									sq.Close();
