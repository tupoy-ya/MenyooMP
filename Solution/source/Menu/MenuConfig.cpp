...
void MenuConfig::ConfigInit()
{
	...
	SetFileAttributes(GetPathff(Pathff::Main, false).c_str(), GetFileAttributes(GetPathff(Pathff::Main, false).c_str()) & ~FILE_ATTRIBUTE_READONLY);
...
void MenuConfig::ConfigRead()
{
	...
	menuPos.x                = ini.GetDoubleValue(section_settings.c_str(), "menuPosX", (menuPos.x + 0.0598f) * 100);
	menuPos.x                = menuPos.x / 100 - 0.0598f;
	menuPos.y                = ini.GetDoubleValue(section_settings.c_str(), "menuPosY", (menuPos.y + 0.074f) * 100);
	menuPos.y                = menuPos.y / 100 - 0.074f;
	...
	sub::Spooner::SpoonerMode::bindsGamepad.first =
	    ini.GetLongValue(section_spooner.c_str(), "SpoonerModeGamepadBind_1", sub::Spooner::SpoonerMode::bindsGamepad.first);
	sub::Spooner::SpoonerMode::bindsGamepad.second =
	    ini.GetLongValue(section_spooner.c_str(), "SpoonerModeGamepadBind_2", sub::Spooner::SpoonerMode::bindsGamepad.second);
	...
	sub::Spooner::Settings::SpoonerModeMode = (sub::Spooner::eSpoonerModeMode)ini.GetLongValue(section_spooner.c_str(), "SpoonerModeMethod", (uint8_t)sub::Spooner::Settings::SpoonerModeMode);
	...
	_ManualRespawn_::g_manualRespawn.Enabled() =
	    ini.GetBoolValue(section_haxValues.c_str(), "manual_respawn", _ManualRespawn_::g_manualRespawn.Enabled());
	...
	g_frozenRadioStation = (int16_t)ini.GetLongValue(section_haxValues.c_str(), "frozen_radio_station", g_frozenRadioStation);
	...
	_MagnetGun_::g_magnetGun.Enabled() =
	    ini.GetBoolValue(section_haxValues.c_str(), "magnet_gun", _MagnetGun_::g_magnetGun.Enabled());
	...
	sub::LaserSight_catind::_colour.R =
	    ini.GetLongValue(section_haxValues.c_str(), "laser_sight_R", sub::LaserSight_catind::_colour.R);
	sub::LaserSight_catind::_colour.G =
	    ini.GetLongValue(section_haxValues.c_str(), "laser_sight_G", sub::LaserSight_catind::_colour.G);
	sub::LaserSight_catind::_colour.B =
	    ini.GetLongValue(section_haxValues.c_str(), "laser_sight_B", sub::LaserSight_catind::_colour.B);
	sub::LaserSight_catind::_colour.A =
	    ini.GetLongValue(section_haxValues.c_str(), "laser_sight_A", sub::LaserSight_catind::_colour.A);
	...
	_SmashAbility_::g_smashAbility.Enabled() =
	    ini.GetBoolValue(section_haxValues.c_str(), "player_smash_ability", _SmashAbility_::g_smashAbility.Enabled());
	...
	_VehicleTow_::g_vehicleTow.Enabled() =
	    ini.GetBoolValue(section_haxValues.c_str(), "vehicle_tow_mode", _VehicleTow_::g_vehicleTow.Enabled());
	_VehicleFly_::g_vehicleFly.Enabled() =
	    ini.GetBoolValue(section_haxValues.c_str(), "vehicle_fly_mode", _VehicleFly_::g_vehicleFly.Enabled());
	...
	_global_MultiPlatNeons_Col.R =
	    ini.GetLongValue(section_haxValues.c_str(), "vehicle_multiplat_neons_R", _global_MultiPlatNeons_Col.R);
	_global_MultiPlatNeons_Col.G =
	    ini.GetLongValue(section_haxValues.c_str(), "vehicle_multiplat_neons_G", _global_MultiPlatNeons_Col.G);
	_global_MultiPlatNeons_Col.B =
	    ini.GetLongValue(section_haxValues.c_str(), "vehicle_multiplat_neons_B", _global_MultiPlatNeons_Col.B);
	...
	_globalSpawnVehicle_plateText =
	    ini.GetValue(section_haxValues.c_str(), "vehicle_spawner_plate_text", _globalSpawnVehicle_plateText.c_str());
	...
	_globalSpawnVehicle_neonCol.R =
	    ini.GetLongValue(section_haxValues.c_str(), "vehicle_spawner_neons_R", _globalSpawnVehicle_neonCol.R);
	_globalSpawnVehicle_neonCol.G =
	    ini.GetLongValue(section_haxValues.c_str(), "vehicle_spawner_neons_G", _globalSpawnVehicle_neonCol.G);
	_globalSpawnVehicle_neonCol.B =
	    ini.GetLongValue(section_haxValues.c_str(), "vehicle_spawner_neons_B", _globalSpawnVehicle_neonCol.B);
	...
	sub::Clock_catind::_analogueClockPos.x =
	    (float)ini.GetDoubleValue(section_haxValues.c_str(), "clock_screen_pos_x", sub::Clock_catind::_analogueClockPos.x);
	sub::Clock_catind::_analogueClockPos.y =
	    (float)ini.GetDoubleValue(section_haxValues.c_str(), "clock_screen_pos_y", sub::Clock_catind::_analogueClockPos.y);
	...
	sub::Speedo_catind::_speedoPosition.x =
	    (float)ini.GetDoubleValue(section_haxValues.c_str(), "speedo_screen_pos_x", sub::Speedo_catind::_speedoPosition.x);
	sub::Speedo_catind::_speedoPosition.y =
	    (float)ini.GetDoubleValue(section_haxValues.c_str(), "speedo_screen_pos_y", sub::Speedo_catind::_speedoPosition.y);
	sub::Speedo_catind::_currentSpeedoBg.fileName =
	    ini.GetValue(section_haxValues.c_str(), "speedo_bg_name", sub::Speedo_catind::_currentSpeedoBg.fileName.c_str());
...
void MenuConfig::ConfigSave()
{
	...
	ini.SetLongValue(section_spooner.c_str(), "SpoonerModeMethod", (uint8_t)sub::Spooner::Settings::SpoonerModeMode);
