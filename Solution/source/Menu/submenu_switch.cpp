...
#include "Submenus/Misc/MiscMapMods.h"
...
#include "Submenus/Player/PlayerOptions.h"
#include "Submenus/Player/StatManager.h"
#include "Submenus/Players/Players.h"
...
#include "Submenus/Weather_Time/WeatherOptions.h"
...
void Menu::submenu_switch()
{
	...
	case SUB::TELEPORTOPS_OFFICEGARAGES_INLOC:
		sub::TeleportLocations_catind::OfficeGarages::Sub_OfficeGarages_InLoc();
		break;
	case SUB::TELEPORTOPS_IEVEHICLEWAREHOUSES:
		sub::TeleportLocations_catind::IeVehicleWarehouses::Sub_IeVehicleWarehouses();
		break;
	case SUB::TELEPORTOPS_IEVEHICLEWAREHOUSES_INLOC:
		sub::TeleportLocations_catind::IeVehicleWarehouses::Sub_IeVehicleWarehouses_InLoc();
		break;
	case SUB::TELEPORTOPS_BIKERCLUBHOUSES:
		sub::TeleportLocations_catind::BikerInteriors::Clubhouses::Sub_Clubhouses();
		break;
	case SUB::TELEPORTOPS_BIKERCLUBHOUSES_INLOC:
		sub::TeleportLocations_catind::BikerInteriors::Clubhouses::Sub_Clubhouses_InLoc();
		break;
	case SUB::TELEPORTOPS_BUSINESSES:
		sub::TeleportLocations_catind::BikerInteriors::Businesses::Sub_Businesses();
		break;
	case SUB::TELEPORTOPS_BUSINESSES_INLOC:
		sub::TeleportLocations_catind::BikerInteriors::Businesses::Sub_Businesses_InLoc();
		break;
	case SUB::TELEPORTOPS_BUNKERS: sub::TeleportLocations_catind::GunRunningInteriors::Bunkers::Sub_Bunkers(); break;
	case SUB::TELEPORTOPS_BUNKERS_INLOC:
		sub::TeleportLocations_catind::GunRunningInteriors::Bunkers::Sub_Bunkers_InLoc();
		break;
	...
	case SUB::TELEPORTOPS_FACILITIES_INOPTION:
		sub::TeleportLocations_catind::Facilities::Sub_Facilities_InOption();
		break;
	...
	case SUB::SPOONER_MANAGEMARKERS_INMARKER_DEST2MARKER:
		sub::Spooner::Submenus::Sub_ManageMarkers_InMarker_Dest2Marker();
		break;
	...
	case SUB::SPOONER_MANAGEDB_REMOVAL:
		sub::Spooner::Submenus::Sub_ManageEntities_Removal();
		break;
	...
	case SUB::SPOONER_TASKSEQUENCE_TASKSUB_SCENARIOACTION_LIST:
		sub::Spooner::Submenus::Sub_TaskSequence::ScenarioAction_list();
		break;
	case SUB::SPOONER_TASKSEQUENCE_TASKSUB_PLAYANIMATION_SETTINGS:
		sub::Spooner::Submenus::Sub_TaskSequence::PlayAnimation_settings();
		break;
	case SUB::SPOONER_TASKSEQUENCE_TASKSUB_PLAYANIMATION_ALLPEDANIMS:
		sub::Spooner::Submenus::Sub_TaskSequence::PlayAnimation_allPedAnims();
		break;
	case SUB::SPOONER_TASKSEQUENCE_TASKSUB_PLAYANIMATION_ALLPEDANIMS_INDICT:
		sub::Spooner::Submenus::Sub_TaskSequence::PlayAnimation_allPedAnims_inDict();
		break;
	case SUB::SPOONER_TASKSEQUENCE_TASKSUB_PLAYSPEECHWITHVOICE_INVOICE:
		sub::Spooner::Submenus::Sub_TaskSequence::PlaySpeechWithVoice_inVoice();
		break;
