...
void PopulatePedModelsArray()
{
	...
	std::vector<std::vector<std::pair<std::string, std::string>>*> vHashLists{{&g_pedModels}, {&g_pedModels_Animal}, {&g_pedModels_AmbientFemale}, {&g_pedModels_AmbientMale}, {&g_pedModels_Cutscene}, {&g_pedModels_GangFemale}, {&g_pedModels_GangMale}, {&g_pedModels_Story}, {&g_pedModels_Multiplayer}, {&g_pedModels_ScenarioFemale}, {&g_pedModels_ScenarioMale}, {&g_pedModels_StoryScenarioFemale}, {&g_pedModels_StoryScenarioMale}, {&g_pedModels_Others}};
	for (auto& hlist : vHashLists)
	{
		std::sort(hlist->begin(), hlist->end(), [](const std::pair<std::string, std::string>& a, const std::pair<std::string, std::string>& b) -> bool {
...
void PopulateVehicleModelsArray()
{
	...
	std::unordered_map<VehicleClass, std::vector<Model>*> vDestMap{{VehicleClass::Super, &g_vehHashes_SUPER},
	    {VehicleClass::Sport, &g_vehHashes_SPORT},
	    {VehicleClass::SportsClassic, &g_vehHashes_SPORTSCLASSIC},
	    {VehicleClass::Coupe, &g_vehHashes_COUPE},
	    {VehicleClass::Muscle, &g_vehHashes_MUSCLE},
	    {VehicleClass::Offroad, &g_vehHashes_OFFROAD},
	    {VehicleClass::SUV, &g_vehHashes_SUV},
	    {VehicleClass::Sedan, &g_vehHashes_SEDAN},
	    {VehicleClass::Compact, &g_vehHashes_COMPACT},
	    {VehicleClass::Van, &g_vehHashes_VAN},
	    {VehicleClass::Service, &g_vehHashes_SERVICE},
	    {VehicleClass::Industrial, &g_vehHashes_SERVICE},
	    {VehicleClass::Military, &g_vehHashes_SERVICE},
	    {VehicleClass::Commercial, &g_vehHashes_SERVICE},
	    {VehicleClass::Utility, &g_vehHashes_SERVICE},
	    //{VehicleClass::Trailer, &g_vehHashes_TRAILER }, //{VehicleClass::Truck, &g_vehHashes_TRUCK }, //{VehicleClass::Pickup, &g_vehHashes_PICKUP },
	    {VehicleClass::Train, &g_vehHashes_TRAIN},
	    {VehicleClass::Emergency, &g_vehHashes_EMERGENCY},
	    {VehicleClass::Motorcycle, &g_vehHashes_MOTORCYCLE},
	    {VehicleClass::Cycle, &g_vehHashes_BICYCLE},
	    {VehicleClass::Plane, &g_vehHashes_PLANE},
	    {VehicleClass::Helicopter, &g_vehHashes_HELICOPTER},
	    {VehicleClass::Boat, &g_vehHashes_BOAT}};
	...
	std::vector<std::vector<Model>*> vHashLists{{&g_vehHashes}, {&g_vehHashes_SUPER}, {&g_vehHashes_SPORT}, {&g_vehHashes_SPORTSCLASSIC}, {&g_vehHashes_COUPE}, {&g_vehHashes_MUSCLE}, {&g_vehHashes_OFFROAD}, {&g_vehHashes_SUV}, {&g_vehHashes_SEDAN}, {&g_vehHashes_COMPACT}, {&g_vehHashes_PICKUP}, {&g_vehHashes_VAN}, {&g_vehHashes_TRUCK}, {&g_vehHashes_SERVICE}, {&g_vehHashes_TRAILER}, {&g_vehHashes_TRAIN}, {&g_vehHashes_EMERGENCY}, {&g_vehHashes_MOTORCYCLE}, {&g_vehHashes_BICYCLE}, {&g_vehHashes_PLANE}, {&g_vehHashes_HELICOPTER}, {&g_vehHashes_BOAT}, {&g_vehHashes_OTHER}};
	for (auto& hlist : vHashLists)
	{
		std::sort(hlist->begin(), hlist->end(), [](const Model& a, const Model& b) -> bool {
